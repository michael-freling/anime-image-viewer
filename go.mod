module github.com/michael-freling/anime-image-viewer
...
replace github.com/michael-freling/anime-image-viewer/plugins/plugins-protos/gen/go => ./plugins/plugins-protos/gen/go
